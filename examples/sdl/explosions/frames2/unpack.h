...
// SpriteSheet sheet(surface, frameWidth, frameHeight);
//
// Create spritesheet that DOES NOT own surface:
// SpriteSheet sheet(surface, frameWidth, frameHeight, NonOwning);
//
// Get frame 7 (altogether and assuming Z-order):
// auto frame7 = sheet[7];
//
// Get the frame in row 5, column 3:
// auto frame53 = sheet(5,3);
